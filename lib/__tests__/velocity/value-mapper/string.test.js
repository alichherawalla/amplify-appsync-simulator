...
describe('JavaString', () => {
    ...
    it('indexOf', () => {
        const str = new string_1.JavaString('Lorem ipsum dolor sit amet, consectetur adipiscing elit');
        expect(str.indexOf(new string_1.JavaString('ipsum'))).toEqual(6);
        expect(str.indexOf(new string_1.JavaString('ipsum'), 10)).toEqual(-1);
    });
    it('isEmpty', () => {
    ...
    it('lastIndexOf', () => {
        ...
        expect(str.lastIndexOf(new string_1.JavaString('Lorem'))).toEqual(57);
        expect(str.lastIndexOf(new string_1.JavaString('Lorem'), 10)).toEqual(0);
        expect(str.lastIndexOf(new string_1.JavaString('foo'))).toEqual(-1);
    });
    it('matches', () => {
        const str = new string_1.JavaString('foo bar');
