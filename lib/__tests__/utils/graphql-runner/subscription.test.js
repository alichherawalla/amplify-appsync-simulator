...
describe('runSubscription', () => {
  ...
  `);
    ...
    `);
        const result = await subscriptions_1.runSubscription(schema, doc, variables, undefined, executionContext);
    ...
    `);
        ...
        const iterator = await subscriptions_1.runSubscription(schema, doc, variables, undefined, executionContext);
